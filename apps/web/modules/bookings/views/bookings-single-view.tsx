                    ...
                    {session === null && !(userIsOwner || props.hideBranding) && (
                      <>
                        ...
                        <div className="text-default pt-8 text-center text-xs">
                          <a href="https://orismeet.com/signup">
                          ...
                          <form
                            onSubmit={(e) => {
                              ...
                              router.push(`https://orismeet.com/signup?email=${target.email.value}`);
                            }}
                            className="mt-4 flex">
                            <EmailInput
                              name="email"
                              ...
                              placeholder="rick.astley@orismeet.com"
                            />
                            <Button
                              type="submit"
                  ...
                  message={
                    <div>
                      ...
                      <span className="underline">
                        <a
                          target="_blank"
                          href="https://orismeet.com/blog/google-s-new-spam-policy-may-be-affecting-your-invitations"
                          rel="noreferrer">
                          {t("resolve")}
                        </a>
                      </span>
