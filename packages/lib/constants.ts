...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://orismeet.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Oris Meet";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@orismeet.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Oris Intelligence Private Limited";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "OrisMeet";
...
export const ROADMAP = "https://orismeet.com/roadmap";
export const DESKTOP_APP_LINK = "https://orismeet.com/download";
export const JOIN_COMMUNITY = "https://orismeet.com/community";
export const POWERED_BY_URL = WEBSITE_URL;
export const DOCS_URL = "https://orismeet.com/docs";
export const DEVELOPER_DOCS = "https://orismeet.com/docs";
...
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://orismeet.com/privacy";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://orismeet.com/terms";
